...
{
	s_account="cnetzdnetfrance-dev,cnetcbsiall-dev";
}else{
	s_account="cnetzdnetfrance,cbsicbsiall";	
}
...
function s_doPlugins(s) {
	...
	s.campaign=s.getQueryParam('ttag,utm_source,utm_medium,utm_campaign','|');
	s.eVar4=s.getQueryParam('tag');
	s.eVar53=s.getNewRepeat(30,'s_getNewRepeat');
	s.eVar54=s.getDaysSinceLastVisit('s_lv_zdnetfr');
	s.eVar50=s.getTimeParting('h','+1');
	s.prop50="D=v50";
	s.eVar51=s.getTimeParting('d','+1');
	s.prop51="D=v51";
}
