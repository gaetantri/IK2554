...
j$('document').ready(function(){
    ...
    j$("#modalWindowSignInBtn").click(function(event){ 
    	...
    	responseHandler = function(responsedata,status,headers){
    		...
    		{    		
    			...
    			if(jsonData.successRedirectUrl)
    			{
    			  ...
    			  var emailAddressOnFile =jsonData.emailAddressOnFile;
    			  var globalCustomerNumber  = jsonData.sid;
