...
function applySubscribedContentFilter(submitUrl, scCheckBoxID) {
    var url_string = submitUrl + document.getElementById("oqs").value;
    var checked = document.getElementById(scCheckBoxID).checked;
    if (checked == false) {
    	url_string = url_string.replace(/%26subscribed%3Dtrue/, '');
    } else {
        url_string = url_string.replace(/%26subscribed%3Dfalse/, '') + '&subscribed=true';
    }
